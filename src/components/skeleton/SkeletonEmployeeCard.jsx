    ...
    <li className="rounded-md h-[230px] md:h-[342px] bg-white/10 border-[1px] border-slate-400/30 md:hover:bg-white/20 relative transition">
      <div className="animate-pulse flex flex-col h-full justify-center">
        ...
        <div className="w-full mx-auto mt-4 flex flex-col items-center gap-3">
          <div className="bg-gray-400 w-[80px] md:w-[110px] h-[18px] md:h-[24px] rounded-md"></div>
          ...
          <div className="bg-gray-400 w-[80px] md:w-[100px] h-[18px] md:h-[21px] rounded-md"></div>
        </div>
      </div>
    </li>
  );
