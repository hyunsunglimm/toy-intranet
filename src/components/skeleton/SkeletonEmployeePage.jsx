      ...
      <div className="w-[600px] bg-white/10 rounded-md border-[1px] border-slate-400/30 p-8 relative animate-pulse">
        ...
        <div className="mt-[60px]">
          <div className="text-center mb-3">
            <div className="h-6 bg-slate-400 rounded w-[130px] mx-auto"></div>
            <div className="h-4 bg-slate-400 rounded w-[100px] mx-auto mt-2 mb-[30px]"></div>
          </div>
          <div className="bg-white/10 rounded-md border-[1px] border-slate-400/30 p-4">
            <div className="h-5 bg-slate-400 rounded w-1/2 mx-auto mb-4"></div>
            <div className="h-5 bg-slate-400 rounded w-4/5 mx-auto "></div>
            <div className="h-5 bg-slate-400 rounded w-4/5 mx-auto m-1"></div>
            <div className="h-5 bg-slate-400 rounded w-4/5 mx-auto m-1"></div>
          </div>
          <div className="mt-10">
            <div className="h-4 bg-slate-400 rounded w-3/4 mx-auto mb-[55px]"></div>
          </div>
        </div>
      </div>
    </div>
